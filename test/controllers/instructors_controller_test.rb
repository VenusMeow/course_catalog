...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { email: @instructor.email, first: @instructor.first, idnum: @instructor.idnum, last: @instructor.last, middle: @instructor.middle } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { email: @instructor.email, first: @instructor.first, idnum: @instructor.idnum, last: @instructor.last, middle: @instructor.middle } }
